...
if __name__ == '__main__':
    data_root = '/media/cliff/SSD/pointnet2_pic/data/s3dis/stanford_indoor3d'
    num_point, test_area, block_size, sample_rate = 4096, 5, 1.0, 0.01

    point_data = S3DISDataset(split='test', data_root=data_root, num_point=num_point, test_area=test_area, block_size=block_size, sample_rate=sample_rate, transform=None)
